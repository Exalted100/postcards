export const placesData = [
    {
        ...
        info: [],
        content: [ {
            paragraphs: ['Lakowe Lakes is a Golf and Country Estate in Lagos, and I was there between the second and sixth of December, 2024. It made me wonder about the difference between a pond and a lake. I had always thought of lakes as very large water bodies, possibly farther than I could see. Apparently not always. There is no clear distinction, but most sources say ponds are small and shallow and lakes are wider and have more depth. Some of the lakes in Lakowe did not appear shallow.',
        ...
        {
            paragraphs: ['I really liked this tree island thing. Most of the lakes were relatively large, uniterrupted pools of water. Some had leaves on their surfaces. One had a duck that often sat close to its edge. But this cluster of trees was the largest and most decorative thing I saw. It looked pretty.',
